            ...
            <div class="card-body">
                <div class="table-responsive">
                	...
                	<div class="row d-flex justify-content-between">
	                	...
	                	<div class="col-3">
	                		<div class="badge rounded-pill bg-danger">　</div> 초과
	                		<div class="badge rounded-pill bg-warning">　</div> 미달
	                		<div class="badge rounded-pill bg-success">　</div> 준수
	                	</div>
            ...
            success: function(res) {
            	...
            	for(var i = 0; i < res.dataList.length; i++){
            		...
            		if(res.dataList[i].workSum > 52){
            			html += "		<div class='badge bg-danger'>초과</div><span class='fs-6'>" + " " + res.dataList[i].workSum + "시간</span>";
            		}else if(res.dataList[i].workSum < 40){
            			html += "		<div class='badge bg-warning'>미달</div><span class='fs-6'>" + " " + res.dataList[i].workSum + "시간</span>";
            		}else{
            			html += "		<div class='badge bg-success'>준수</div><span class='fs-6'>" + " " + res.dataList[i].workSum + "시간</span>";
            		}
            		html += "		</h5>";
            		html += "	</td>";
            		html += "</tr>";
