...
<!-- 							</div> -->
					...
					<div class="col-md-3">
						...
						<div class="row">
							<span class="fw-bold fs-5">${emp.empDept } <c:if test="${empty emp.empPos }">${emp.empPos }</c:if></span>
						</div>
						&nbsp; &nbsp;
						<div class="row">
				...
				<div class="tab-content p-3 text-muted">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div style="padding: 30px;">
									...
									<p class="fw-bold px-4 py-2 fs-6">${emp.empDept }＊${emp.empPos }</p>
					...
					<div class="tab-pane" id="profile1" role="tabpanel">
						...
						<div class="row">
							...
							<sec:authorize access="hasAnyRole('ROLE_MANAGER','ROLE_ADMIN')">
								<div style="padding: 30px;">
									<div class="card border border-2" style="max-width: 18rem;" id="workBtn2">
									  <div class="card-header"><b>근무시간</b></div>
									  <div class="card-body text-secondary">
									    <h5 class="card-title" align="right"><b>시간</b></h5>
									  </div>
									</div>
									<div class="card border border-2" style="max-width: 18rem;" id="vacationBtn2">
									  <div class="card-header"><b>남은 연차</b></div>
									  <div class="card-body text-secondary">
									    <h5 class="card-title" align="right"><b>일</b></h5>
									  </div>
									</div>
									<div class="card border border-2" style="max-width: 18rem;" id="payBtn2">
									  <div class="card-header"><b>급여</b></div>
									  <div class="card-body text-secondary">
									    <h5 class="card-title" align="right"><b>월 급여 명세서</b></h5>
									  </div>
									</div>
								</div>
							</sec:authorize>
						...
						<!-- work modal start -->
						<div id="workModal2" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="myExtraLargeModalLabel"><b>나의 근무시간</b></h5>
						...
						<!-- work modal end -->
						<!-- vacation modal start -->
						<div id="vacationModal2" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="myExtraLargeModalLabel"><b>나의 휴가</b></h5>
						...
						<!-- vacation modal end -->
						<!-- pay modal start -->
						<div id="payModal2" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content">
									<div class="modal-header">
					...
					<div class="tab-pane" id="messages1" role="tabpanel">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div style="padding: 30px;">
									<div class="card border border-2" style="max-width: 18rem;" id="workBtn3">
									  <div class="card-header"><b>근무시간</b></div>
									  <div class="card-body text-secondary">
										<h5 class="card-title" align="right"><b>시간</b></h5>
									  </div>
									</div>
									<div class="card border border-2" style="max-width: 18rem;" id="vacationBtn3">
									  <div class="card-header"><b>남은 연차</b></div>
									  <div class="card-body text-secondary">
										<h5 class="card-title" align="right"><b>일</b></h5>
									  </div>
									</div>
									<div class="card border border-2" style="max-width: 18rem;" id="payBtn3">
									  <div class="card-header"><b>급여</b></div>
									  <div class="card-body text-secondary">
										<h5 class="card-title" align="right"><b>월 급여 명세서</b></h5>
									  </div>
