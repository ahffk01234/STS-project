		...
		<div class="row">
			<div class="col-4">
				<div class="card shadow-lg">
					<div class="card-body">
						<h5 class="card-title fw-bold"><span class="badge bg-lg bg-primary"> </span> 자동부여</h5>
						<div class="card-body">
							<h4 id="outo" class="card-text fw-bold text-primary">
							</h4>
						</div>
					</div>
				</div>
    ...
    function updateUI(data) {
    	...
    	for(var i = 0; i < data.length; i++){
	        ...
	        if(data[i].vpChgCase == '자동부여'){
		        ...
		        html += "<td><font class='text-primary fw-bold'>+" + data[i].vpAddDays + "일</font></td>";
	        }else{
		        html += "<td></td>";
	        }
	        	
	        if(data[i].vpChgCase == '자동소멸'){
		        html += "<td><font class='text-danger fw-bold'>-" + data[i].vpSubDays + "일</font></td>";
	        }else{
		        html += "<td></td>";
	        }
	        
	        if(data[i].vpChgCase == '조정'){
		        html += "<td><font class='text-success fw-bold'>+" + data[i].vpAddDays + "일</font></td>";
	        ...
	        html += "<td><font class='text-secondary fw-bold'>" + data[i].vpDays + "일</font></td>";
	        html += "</tr>";
