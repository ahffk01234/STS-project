...
// 				location.href="/settings/list";
	...
	autoHoliBtn.on("click", function() {
		...
		vacName.attr("value", "테스트 휴가");
		vacAmt.attr("value", "1일");
		vacGenAll.attr("checked", "checked");
		vacWgPay.removeAttr("checked", "checked");
		vacCert.attr("checked", "checked");
		
		var content = "테스트용 휴가에 관한 설명입니다.";
